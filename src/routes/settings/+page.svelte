  ...
  <div class="flex items-center justify-between pb-6">
    ...
    <div class="col-span-8 overflow-hidden rounded-xl sm:bg-gray-50 sm:px-8 sm:shadow">
      ...
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <p class="text-gray-600">Your username is <strong>Admin01</strong></p>
      ...
      <div class="grid border-b py-6 sm:grid-cols-2">
        <div class="">
          <h2 class="text-lg font-semibold leading-4 text-slate-700">New notification</h2>
          <p class="font- text-slate-600">No notification.</p>
        </div>
        </div>
    </div>
  </div>
